...
public class RegExp
{
    ...
    {
        SortedSet<String> emptyLanguage = new TreeSet<>(compareByLength);
        SortedSet<String> languageResult = new TreeSet<>(compareByLength);
        ...
        switch (this.operator) {
            ...
            case PLUS:
                ...
                {   HashSet<String> languageTemp = new HashSet<>(languageResult);
                    for (String s1 : languageLeft)
